...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { house: @inquiry.house, msg: @inquiry.msg, subject: @inquiry.subject, user: @inquiry.user } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { house: @inquiry.house, msg: @inquiry.msg, subject: @inquiry.subject, user: @inquiry.user } }
